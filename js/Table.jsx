                        ...
                        <div className="panel-body">
                            <form role="form" className="form-inline">
                                <div className="form-group">
                                    <input type="text" defaultValue="" style={{width:"100%"}} className="form-control" ref="name" placeholder="搜索"></input>

                                </div>
                                <div className="form-group">
                                    <button type="submit"  onClick={this.handleSearch} className="btn btn-success  btn-block">搜索</button>
                                </div>
                            </form>
                        </div>
                    </div>
