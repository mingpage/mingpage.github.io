 ...
 * 前端使用
 */
app.get("/listByPage",async function (req,res) {
    mi_resource.list({parent_id:req.params.parent_id,name:{"like":req.params.name||""},username:userInfo.username}).then(d=>res.send(d))
});

app.get("/listAllRoot",async function (req,res) {
